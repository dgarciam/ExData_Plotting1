...
gfxData$FullDate = as.POSIXct(paste(as.Date(gfxData$Date),gfxData$Time)) ##Adding Dates and Times for Last Plot

library(datasets)
hist(gfxData$Global_active_power,col="red", main = "Global Active Power", xlab = "Global Active Power (kilowatts)")
